        ...
        try {
          ...
          setTimeout(() => {
            ...
            if (canvas) {
              ...
              console.log(
                "Particles.js canvas not created, using CSS fallback"
              );
            }
          }, 500);
        } catch (error) {
          ...
          <div className="col-lg-6 col-md-6">
            <div className="banner_content" data-aos="fade-right">
              ...
              <h1 className="cd-headline clip">
                <span className="fw_600" style={{ marginRight: "15px" }}>
                  I Am{" "}
                </span>
                <span className="cd-words-wrapper">
                  <b className="fw_600">Ramadhan Zain</b>
                  <b className="fw_600">BackEnd Developer</b>
                </span>
              </h1>
              <p>
                An active Informatics Engineering student at the University of
                Lampung with a strong interest in Cloud Computing and
                Networking. Skilled in software development and analytical
                thinking, with proficiency in C++, Python, HTML, JavaScript, and
                MySQL. Eager to learn and contribute to the information
                technology industry.
              </p>
              <a
